	...
	public function create($Firstname, $Lastname, $password, $Lifeguard, $Instructor, $Headguard, $Supervisor ) 
    {
		...
		{	
			...
			{								
				...
				$this->ConvertedLifeguard  =  ($Lifeguard) ?  'Yes' : 'No' ;
				$this->ConvertedInstructor =  ($Instructor)  ? 'Yes' : 'No';
				$this->ConvertedHeadguard  =  ($Headguard)  ? 'Yes' : 'No';
				$this->CovertedSupervisor  =  ($Supervisor) ? 'Yes' : 'No';								
				
				$this->madeit; //This madeit variable will hold the return message for confiming the employee was created.
				$this->madeit = "<h3>The Employee was created. </h3><p> Firstname:".$Firstname."     <br> Lastname: ".$Lastname."   <br> Password: ".$password."   <br>  Lifeguard:". $this->ConvertedLifeguard ." <br>  Instructor:". $this->ConvertedInstructor."   <br>  Headguard:".$this -> ConvertedHeadguard."  <br> Supervisor:".$this->CovertedSupervisor."   </p>";
